...
class WfuCardView extends StatefulWidget {
  const WfuCardView({super.key});

  @override
  State<WfuCardView> createState() => _WfuCardViewState();
}

class _WfuCardViewState extends State<WfuCardView> {
  int? projectId;
  int? packageId;
  @override
  void initState() {
              ...
              GridView.count(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: _buildGlassCard("WFU Packages"),
                  ),
                  GestureDetector(
                    onTap: () {
                      Get.toNamed(
                    ...
                    child: _buildGlassCard("WFU Detail"),
                  ),
                ],
              ),
            ],
