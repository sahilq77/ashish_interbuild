...
class WorkFrontUpdateDetailListView extends StatefulWidget {
  const WorkFrontUpdateDetailListView({super.key});

  @override
  State<WorkFrontUpdateDetailListView> createState() =>
      _WorkFrontUpdateDetailListViewState();
}

class _WorkFrontUpdateDetailListViewState
    extends State<WorkFrontUpdateDetailListView> {
  ...
  void initState() {
    ...
    log(
      "WFU Detail → Source=${controller.sourceName.value} System Id=${controller.systemId.value}",
    );
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  "Skyline Towers ➔ WFU List ➔ WFU Detail",
  ...
  Widget _buildBottomButton(WorkFrontUpdateDetailListController controller) {
    return Obx(
      () => Container(
  ...
  AppBar _buildAppbar(WorkFrontUpdateDetailListController controller) {
    return AppBar(
  ...
  void _showFilterDialog(BuildContext context) {
    final controller = Get.find<WorkFrontUpdateDetailListController>();
