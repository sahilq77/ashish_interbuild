...
class WeeklyInspectionCardView extends StatefulWidget {
  const WeeklyInspectionCardView({super.key});

  @override
  State<WeeklyInspectionCardView> createState() =>
      _WeeklyInspectionCardViewState();
}

class _WeeklyInspectionCardViewState extends State<WeeklyInspectionCardView> {
  int? projectId;
  int? packageId;
  @override
  void initState() {
              ...
              GridView.count(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: _buildGlassCard("WIR Packages"),
                  ),
                  GestureDetector(
                    onTap: () {
                      Get.toNamed(
                    ...
                    child: _buildGlassCard("WIR Detail"),
                  ),
                ],
              ),
            ],
