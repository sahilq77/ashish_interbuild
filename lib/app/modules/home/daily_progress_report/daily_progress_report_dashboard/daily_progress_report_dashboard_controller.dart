...
class DailyProgressReportDashboardController extends GetxController {
  ...
  void onInit() {
    ...
    log(
      "DPR Dashboard → projectId=${projectId.value} packageId=${packageId.value}",
    );
    ...
    try {
      ...
      final response =
          await Networkcall().getMethod(
                Networkutility.getDPRdashboardApi,
                "${Networkutility.getDPRdashboard}?project_id=$projectId&filter_package=$packageId",
                context,
              )
