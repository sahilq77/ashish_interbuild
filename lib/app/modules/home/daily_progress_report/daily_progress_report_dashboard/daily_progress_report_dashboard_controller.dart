...
class DailyProgressReportDashboardController extends GetxController {
  ...
  void fetchDashboardData() {
    ...
    monthlyPercent.value = calculatePercentage(monthlyAchieve.value, monthlyTarget.value);

    weeklyTarget.value = 250000.0; // Example: ₹2,50,000
    weeklyAchieve.value = 200000.0; // Example: ₹2,00,000
    weeklyPercent.value = calculatePercentage(weeklyAchieve.value, weeklyTarget.value);

    dailyTarget.value = 50000.0; // Example: ₹50,000
    dailyAchieve.value = 45000.0; // Example: ₹45,000
    dailyPercent.value = calculatePercentage(dailyAchieve.value, dailyTarget.value);
  }
