...
class MeasurmentSheetDeductionListController extends GetxController {
  // ── UI State ─────────────────────────────────────────────────────
  ...
  Future<void> fetchPboq({
    ...
    try {
      ...
      final String endpoint = Networkutility.pboqDeductionsList + query;
      final response =
          await Networkcall().getMethod(
                Networkutility.pboqDeductionsListApi,
                endpoint,
                context,
              )
